...
- [x] Normalize Facebook inbound payload, không để provider DTO lọt vào domain. `FR-08`
...
- [x] Triển khai IMAP polling cho một mailbox. `FR-07`
- [x] Normalize plain-text email fields và bỏ qua attachments. `FR-07`, `NFR-04`
- [x] Triển khai email threading bằng `In-Reply-To` và `References`. `FR-07`
- [x] Deduplicate email messages bằng Redis và PostgreSQL. `FR-07`, `FR-10`, `NFR-03`
